...
export default function SignupPage() {
  ...
  <Card className="mx-auto w-full max-w-sm">
    <CardHeader className="text-center space-y-2">
      ...
      <CardTitle className="font-headline text-3xl">إنشاء حساب</CardTitle>
      <CardDescription>أدخل معلوماتك لإنشاء حساب جديد على HsebliTrade</CardDescription>
    </CardHeader>
    <CardContent>
      <form onSubmit={handleSubmit(onSubmit)} className="grid gap-4">
        ...
        <Button
          ...
          disabled={isSubmitting || isGoogleLoading}
        >
          {isSubmitting ? "يتم إنشاء الحساب..." : "إنشاء حساب"}
        </Button>
      </form>
      ...
      <Button
        ...
        disabled={isSubmitting || isGoogleLoading}
      >
        {isGoogleLoading ? "جاري تسجيل الدخول..." : "سجل بحساب Google"}
      </Button>
