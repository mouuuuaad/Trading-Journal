           ...
           <div className="flex justify-center items-center gap-4 mb-4">
             <Avatar className="h-16 w-16">
              ...
              <div>
                ...
                <CardDescription className="mt-1">Need help? Reach out to the creator directly.</CardDescription>
              </div>
           </div>
        </CardHeader>
        <CardContent className="space-y-4">
            <p className="font-medium text-foreground">
              If you're facing any issues or have questions, please don't hesitate to get in touch.
            </p>
